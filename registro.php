                ...
                <li>
                  <div class="tabla-precio">
                    ...
                    <div class="orden">
                        ...
                        <input type="number" min="0" size="3" id="pase_dia" name="boletos[un_dia][cantidad]" placeholder="0">
                ...
                <li>
                  <div class="tabla-precio">
                    ...
                    <div class="orden">
                        ...
                        <input type="number" min="0" size="3" id="pase_completo" name="boletos[completo][cantidad]" placeholder="0">
                ...
                <li>
                  <div class="tabla-precio">
                    ...
                    <div class="orden">
                        ...
                        <input type="number" min="0" size="3" id="pase_dosdias" name="boletos[dos_dias][cantidad]" placeholder="0">
